...
public class HuggingFaceService {
	...
	public boolean containsScamKeywords(String combinedText) {
		List<String> scamKeywords = Arrays.asList("kapora", "noter gerekmez", "hemen gönder", "havale", "peşin",
				"elden ödeme", "sözleşme yok", "resmiyet gerekmez", "resmi değil", "tapu sonradan", "detaylar gizli",
				"whatsapp", "sadece bugün", "bugün için özel", "acil satılık", "çok ucuz", "komisyon yok",
